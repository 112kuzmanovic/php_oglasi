            ...
            <div class="col-4">
                <div class="card mb-2 mt-2">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="single.oglas.php?id=<?php echo $oglas['id'] ?>" clas="btn btn-light btn-sm">Vidi oglas</a>
                    </div>
                    <div class="card-footer">
                        <a href="user.view.php" class="btn btn-warning btn-sm float-left"><?php echo $oglas['name'];?></a>
